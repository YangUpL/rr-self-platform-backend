...
/**
 * @PATH com.yangrr.rrmianshi.strategy.AdminUpdateUser
 * @Author YangRR
 * @CreateData 2025-02-11 10:17
 * @Description:
 */
@Component
public class AdminUpdateUser implements UpdateUserStrategy {
    ...
    public Boolean updateUser(UpdateUserDto updateUserDto, HttpServletRequest request) {
        ...
        Integer role = updateUserDto.getRole();
        ...
        updateUserDto.setAvatar(updateUserAvatar.check(username, email, role, avatar));
